...
\input{method_and_implementation.tex}

\input{evaluation.tex}
    
\input{conclusions.tex}

\input{recommendations_for_future_work.tex}
...
\label{sec:Referencing}
    ...
    \label{sec:Citations}
        ...
        \subsubsection{Citing References}
            ...
            \begin{itemize}
                \item \textit{\textbackslash citet} is for textual citations, e.g. ```\citet{smith1999an} did some cracking work about fish''.
                \item \textit{\textbackslash citep} is for citations in parentheses , e.g. ```Fish like to live in the water \citep{smith1999an}''.
            \end{itemize}
